...
What do we wish to accomplish with the controlling of the robot? Give the huge variaty in posible robitic designes let us once agine assume that are robot is just a suoped up RC car. 
