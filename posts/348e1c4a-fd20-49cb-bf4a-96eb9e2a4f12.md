...
So the generator loss is simple. The generator want the discriminator to think its samples were real. So it just computes loss using 1 as the label for all the generated samples.