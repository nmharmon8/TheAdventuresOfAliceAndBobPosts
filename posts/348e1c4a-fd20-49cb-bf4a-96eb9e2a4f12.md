...
Imitation learning is one way to do away with simulation. As the name suggest is imitating an existing control algorithum. In this case we will use a human driver a the existing control algorithum. 
