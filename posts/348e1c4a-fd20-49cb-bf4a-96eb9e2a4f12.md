...
How do we collect the data. Many popular robotic control systems are based on Reinforcement Learning. The Reinforcement Learning approches works very well, but for most case requires 
