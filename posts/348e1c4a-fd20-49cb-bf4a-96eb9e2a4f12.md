...
This learning approach breaks the direct relationship between the labels and the output of the encoder/generator. Reframing the learning task as learning a distribution rather then a mapping. This solves the problem we faced with the encoder reverting to the mean.
