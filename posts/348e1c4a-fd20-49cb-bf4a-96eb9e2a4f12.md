...
Yet there is an inherent limitation to using a Encoding approch to imatation learning. It dose not matter if the encoder is linear or nonlinear. This is the same problem that autoencoders run into. reversion to the mean
