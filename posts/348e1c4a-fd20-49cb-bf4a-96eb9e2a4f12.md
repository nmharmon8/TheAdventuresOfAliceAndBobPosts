...
What is the solution, it is the mighty GAN (Generative Adversarial Network). The GAN first got famouse for its ablity learn the distrubtion of a set of images and
