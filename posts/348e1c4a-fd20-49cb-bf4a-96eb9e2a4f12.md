...
What do we wish to accomplish with controlling the robot? Given the huge variety in possible robotic designs, let us assume that our robot is a souped up RC car. And we just wish the robotic car to drive from point A to point B.
