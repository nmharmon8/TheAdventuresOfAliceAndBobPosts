...
Now lets talk about the loss function for a sec. The discriminator has a loss function focused on classifying if samples are from the Real distribution or from the generated distribution. W