...
Once the generator is trained you can trow out the discriminator and just use the generator to drive your robot. However the discriminator can come in handy for detecting if the robot dose not actually know how to handle a specific sensor data input. 

Congradulations, hopfuly you have a vison for how to use a GAN based apprch for imatation learning.
