...
Ends up GANs are good at learning lots of different distributions. This includes the distribution over driving commands to a robot. There are lots of ways people describe GANs, but the part we care abouth 