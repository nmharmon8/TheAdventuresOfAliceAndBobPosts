...
Once the generator is trained you can trow out the discriminator and just use the generator to drive your robot. However the discriminator can come in handy for detecting when the robot is no longer in a 
