...
Now that we have a framework for discussion, we can begin to think about the m design of the machine learning. The flow of data is fairly strait forward. We wish to transform the sensor input into drive commands.
