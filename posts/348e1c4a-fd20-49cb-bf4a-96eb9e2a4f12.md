...
Now you have a simple data set that give a mapping from sensor data to commands. To be fair most imitation learning is formulated as reinforcment learing, but it dose not have to be. Inorder to keep things as simple as possible we will not look at it from the reinforcment learning persepctive. We will just formulat imtation learning as a 
