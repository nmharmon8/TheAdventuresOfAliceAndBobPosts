...
3. Input the sensor data plus the noise vector z into the generator, outputting a drive command.
4. Sample another random sensor data example and drive command label.
5. Give the discriminator ()