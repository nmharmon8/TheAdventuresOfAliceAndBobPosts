...
There is a lot is that training loop. Fist as was mentioned earlier this is a conditional GAN. So the generator takes in sensor data and a noise vector, vs a traditanl GAN would take in only a noise vector.  