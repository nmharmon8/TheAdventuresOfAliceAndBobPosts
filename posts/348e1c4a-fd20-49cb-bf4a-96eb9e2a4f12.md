...
Note that the discriminator just has one output and it is just 1 or 0 for real or generated. In practice you have to keep the discriminator and generator some what 
