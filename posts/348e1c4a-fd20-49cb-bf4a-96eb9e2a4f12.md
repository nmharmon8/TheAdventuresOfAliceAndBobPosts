...
This is an over simplified example. If you have image data coming from a camera then it make a lot of sinces to use convolutional layers to learning featuers from the image. 
