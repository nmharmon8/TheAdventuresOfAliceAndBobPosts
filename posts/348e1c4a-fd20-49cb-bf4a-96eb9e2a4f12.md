...
Imagine your robot is approaching an obstical. It can go left or right, both way are open. Which way should the nerual network command the robot to go? Now comes reversion to the mean. Lets assume when the humane driver that we are learning to imatate was driving around, they drove around obsticals someti 
