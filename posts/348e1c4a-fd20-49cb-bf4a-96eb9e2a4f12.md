...
What is the solution? The mighty GAN (Generative Adversarial Network). The GAN first got famous for its ability learn the distribution of a set of images. Learn the distribution of images is fancy speak for generate images that are simalar to a set of training images.
