...
What is the solution? The mighty GAN (Generative Adversarial Network). The GAN first got famouse for its ablity learn the distrubtion of a set of images. Learn the distrubtion of images is just fancy speak for genrate images that are similuer to a set of training images.
